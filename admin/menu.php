<ul class="sidebar-menu">
    ...
    <?php if ($user['level'] == 'admin') { ?>
        <li class="dropdown ">
            <a href="#" class="nav-link has-dropdown"><i class="fas fa-toolbox fa-fw"></i> <span>Data Master</span></a>
            <ul class="dropdown-menu">
                ...
                <li><a class="nav-link" href="?pg=keterampilan">Master Keterampilan</a></li>
    ...
    <?php } ?>
    <li class="dropdown ">
        <a href="#" class="nav-link has-dropdown"><i class="fas fa-users"></i> <span>Data Pendaftar</span></a>
        <ul class="dropdown-menu">
