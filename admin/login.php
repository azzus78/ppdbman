...
<head>
  ...
  <title>Login &mdash; PPDB MAN 1 NGANJUK</title>
  <!-- <div style="background-image: url('../assets/img/man3.jpg');"> -->
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand" style="margin-bottom: 15px">
              <img src="../<?= $setting['logo'] ?>" alt="logo" width="85" draggable="false">
            </div>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form id="form-login" class="needs-validation" novalidate="">
                  ...
                  <div class="form-group">
                    <div class="d-block">
                      ...
                      <div class="float-right">
                        <a href="https://bit.ly/Bayu_Eka" class="text-small">
                          Lupa Password?
                        </a>
                      </div>
                    </div>
                    <input id="password" type="password" class="form-control" name="password" tabindex="2" required><br>
                    <input type="checkbox" onclick="myFunction()"><label>&nbsp;Tampilkan Password</label>
                    <div class="invalid-feedback">
                  ...
                  <div class="form-group">
                    <button name="login" type="submit" class="btn btn-warning btn-lg btn-block" tabindex="4">
                      Login
                    </button>
                  </div>
                </form>
