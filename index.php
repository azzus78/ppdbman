...
<style>
body  {
  background-image: url("../ppdb/assets/img/banner-bg.svg");
...
<body class="layout-3">
    ...
    <div id="app">
        <div class="main-wrapper container">
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                            <img alt="image" src="assets/img/avatar/avatar5.png" class="rounded-circle mr-1">
            ...
            <!--<nav class="navbar navbar-secondary navbar-expand-lg" style="height:2px">-->
                <!--<div class="container">-->
                <!--    <ul class="navbar-nav">-->
                <!--        <li class="nav-item">-->
                ...
                <!--        </li>-->
                <!--        <li class="nav-item">-->
                <!--            <a href="#" class="nav-link klikmenu " data-id="pendaftaran"><i class="fas fa-edit    "></i><span>Daftar Akun</span></a>-->
                <!--        </li>-->
                <!--        <li class="nav-item">-->
                                                                ...
                                                                <div class="activities">
                                                                    <div class="activity">
                                                                        ...
                                                                        <div class="activity-detail">
                                                                            ...
                                                                            <p><button type="button" data-id="pendaftaran" class="btn klikmenu btn-warning">Daftar Akun</button></p>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="activities">
                                                                    <div class="activity">
                                                                        ...
                                                                        <div class="activity-detail">
                                                                            ...
                                                                            <p><button type="button" data-id="login" class="klikmenu btn btn-danger">Login Masuk</button></p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="activities">
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; <?= date('Y') ?> MAN 1 NGANJUK <div class="bullet"></div> Support By <a href="https://man1nganjuk.sch.id/"><font color="#1ABC9C">Politeknik Elektronika Negeri Surabaya & Institut Teknologi Sepuluh November Surabaya</font></a>
                </div>
