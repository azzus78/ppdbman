...
$pekerjaan = array("Tidak Bekerja", "Buruh", "Karyawan Swasta", "Pedagang", "Pensiunan", "Petani", "Peternak", "PNS/TNI/POLRI", "Sudah Meninggal", "Tenaga Kerja Indonesia", "Wirausaha", "Tidak Bekerja", "Guru", "Dosen", "Dokter", "Perangkat Desa", "Sopir");
...
$jenistinggal = array("Bersama Orang Tua", "Bersama Wali", "Kost", "Mondok");
$jeniskelamin = ["L" => "Laki-laki", "P" => "Perempuan"];
$jeniskelaminbiaya = ["S" => "Semua", "L" => "Laki-laki", "P" => "Perempuan"];
$jenjangsekolah = array("SMP", "MTs");
$statussekolah = array("Negeri", "Swasta");
$statuskartu = array("Penerima", "Bukan Penerima");
$jeniskartu = array("KKS", "PKH", "PIP", "SKM");
$tingkatprestasi = array("Kecamatan","Kabupaten/Kota", "Provinsi", "Nasional","Internasional");
$peringkatprestasi = array(1, 2, 3, 4, 5, 6);
