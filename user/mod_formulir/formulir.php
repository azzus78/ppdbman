                    ...
                    <ul class="nav nav-pills" id="myTab3" role="tablist">
                        ...
                        <?php } ?>
                            ...
                            <form id="form-datadiri">
                                ...
                                <!--<center><div><font color="green">Foto Formal Berseragam Ukuran 3X4</font></div> -->
                                <!--<img alt="image" src="mod_formulir/<?= $siswa['foto'] ?>" class="rounded-circle author-box-picture">  <button type="button" class="btn btn-info btn-sm mb-0"  data-toggle="modal" data-target="#gantifoto">Upload Foto</button></center><br>-->
                                <div class="form-group row mb-2">
                        ...
                        <?php } ?>
                            <form id="form-alamat">
                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-sm-12 col-md-4">
                                        <input type="text" name="npsn" class="form-control" maxlength="8" value="<?= $siswa['npsn_sekolah'] ?>" required>
                                    </div>
                                </div>
                                <div class="form-group row mb-2">
    ...
    $('.form-control').keyup(function(event) {
      ...
      $(document).ready(function() {
        ...
        $('#form-asal-sekolah').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'mod_formulir/crud_formulir.php?pg=simpanasalsekolah',
                data: $(this).serialize(),
                beforeSend: function() {
                    $('#btnsimpan').prop('disabled', true);
                },
        ...
        $('#form-info-kartu').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'mod_formulir/crud_formulir.php?pg=simpaninfokartu',
                data: new FormData(this),
                processData: false,
                contentType: false,
                cache: false,
        ...
        $('#form-ganti-foto').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'mod_formulir/crud_formulir.php?pg=gantifoto',
                data: new FormData(this),
                processData: false,
                contentType: false,
                cache: false,
        ...
        $('#form-prestasi').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'mod_formulir/crud_formulir.php?pg=simpanprestasi',
                data: new FormData(this),
                processData: false,
                contentType: false,
                cache: false,
